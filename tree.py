    ...
    def validate_node(self) -> None:
        ...
        for child in self.children:
            if type(child) == Slot or type(child) == Root:
                print("root" + "A Root's child must be an Intent or Token: ")
                print(child)
                print(type(child))
                raise TypeError(
                    "A Root's child must be an Intent or Token: " + self.label)
            elif self.parent is not None:
                print("A Root should not have a parent: ",self.parent,"ROOT")
                raise TypeError(
    ...
    def validate_node(self) -> None:
        ...
        for child in self.children:
            if type(child) == Intent or type(child) == Root:
                print("intent Error")
                print("An Intent's child must be a slot or token: " + self.label)
                raise TypeError(
...
class Slot(Node):
    ...
    def validate_node(self) -> None:
        ...
        for child in self.children:
            if type(child) == Slot or type(child) == Root:
                print("slot error")
                print("An Slot's child must be an intent or token: "
                                + self.label)
                print(self.children)
...
class Token(Node):
    ...
    def validate_node(self) -> None:
        if len(self.children) > 0:
            print("A Token {} can't have children: {}".format(
                self.label, str(self.children)),"Token")
...
class Tree:
    def __init__(self, top_repr: str) -> None:
        ...
        try:
            ...
            print("Tree Validation failed","tree")
